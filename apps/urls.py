...
urlpatterns = [
    ...
    path('attendance/', AttendanceSelectView.as_view(), name='attendance_select'),
    path('attendance/<int:lesson_id>/<str:date>/', AttendanceMarkView.as_view(), name='attendance_mark'),
]
